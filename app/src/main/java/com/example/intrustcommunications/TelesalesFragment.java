 ...
 * @version 01.07.2019
 */
public class TelesalesFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View telesalesView = inflater.inflate(R.layout.fragment_telesales, container, false);

        //set listeners
        setOnClickListeners(telesalesView);

        return telesalesView;
    }
    ...
    public void onClick(View view) {
        ...
        //check if contact us button is clicked
