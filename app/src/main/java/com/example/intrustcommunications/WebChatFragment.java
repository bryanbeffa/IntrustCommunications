 ...
 */
public class WebChatFragment extends Fragment implements View.OnClickListener {

    private final int CONTACT_US_ID = 6;
    private CurrentFragmentManager cfManager;
    private NavigationView navigationView;

    public WebChatFragment(CurrentFragmentManager cfManager, NavigationView navigationView) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View webChatView = inflater.inflate(R.layout.fragment_web_chat, container, false);

        //set listener
        setOnClickListeners(webChatView);
